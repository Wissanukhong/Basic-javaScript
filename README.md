...
- while loop  
  เป็นการเขียนโปรแกรมเพื่อให้โปรแกรมทำซ้ำไปเรื่อยๆ เมื่อเงื่อนไขยังคงมีค่าเป็นจริงอยู่ และจะหยุดทำซ้ำเมื่อเงื่อนไขเป็นเท็จ
...
- global variable คือ ตัวแปรที่สามารถเรียกใช้งานได้ทั้งโปรแกรม
- Local variable คือ ตัวแปรที่สามารถเรียกใช้งานได้เฉพาะ Block scrop เท่านั้น

### ชนิดของตัวแปร

1. var สามารถ assign ค่าใหม่ได้
2. let สามารถ assign ค่าใหม่ได้
3. const ไม่สามารถ assign ค่าใหม่ได้
...
### หลักการตั้งชื่อตัวแปรสำหรับภาษา javaScript
...
- Object คือส่วนต่างที่อยู่ภายในโครงสร้างซึ่งเราจะมองเป็น Object
  - `<body></body>` object ของ body
  - `<header></header>`object ของ header
